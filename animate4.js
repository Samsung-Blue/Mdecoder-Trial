...
function addDigits()
{
	...
	{
		digits[i]={};
		digits[i].digit=Math.floor(Math.random()*9);
		digits[i].speedX = Math.floor(5*Math.random())+1;
		digits[i].speedY = Math.floor(5*Math.random())+1;
		...
		digits[i].fontSpeed = Math.floor(4*Math.random())+1;
 		ctx.font = digits[i].fontSize+"px Arial";
 		rc = Math.floor(255*Math.random());
		gc = Math.floor(255*Math.random());
		bc = Math.floor(255*Math.random());
		digits[i].rc = rc;
		digits[i].gc = gc;
		digits[i].bc = bc;
